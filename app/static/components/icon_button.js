...
(() => {
  ...
  const ICONS = {
    ...
    help: ['M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z', 'M9.8 9a2.4 2.4 0 1 1 3.4 2.2c-.9.5-1.2 1-1.2 2', 'M12 17h.01'],
    ...
    'rotate-left': ['M5 5v5h5', 'M5.8 10A7 7 0 1 1 6 15'], 'rotate-right': ['M19 5v5h-5', 'M18.2 10A7 7 0 1 0 18 15'],
    volume: ['M4 10v4h4l5 4V6l-5 4z', 'M16 9a4 4 0 0 1 0 6', 'M18 6a8 8 0 0 1 0 12'], queue: ['M5 6h12', 'M5 12h12', 'M5 18h8', 'M19 17v4', 'M17 19h4'],
    check: ['M5 12l4 4L19 6'], blocked: ['M5 5l14 14', 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z'], 'stage-blocked': ['M12 5v9', 'M12 18h.01'], current: ['M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16z', 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z'],
